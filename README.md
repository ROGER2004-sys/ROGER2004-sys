...
<div align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,python,java&perline=12" />
  <br/>
  <!-- Icône Oracle personnalisée -->
  <img src="TON_URL_LOGO_ORACLE" alt="Oracle" width="48" />
</div>

<div align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,ts,python,java,c,cpp,cs,go,rust,php,ruby,kotlin,swift,dart,scala,react,vue,angular,nextjs,nodejs,nestjs,express,django,flask,fastapi,laravel,spring,mysql,postgres,mongodb,sqlite,neo4j,redis,docker,kubernetes,nginx,aws,azure,gcp,linux,ubuntu,windows,git,github,gitlab,vscode,idea,pycharm,postman,figma,bash,jenkins&perline=12" />
</div>
